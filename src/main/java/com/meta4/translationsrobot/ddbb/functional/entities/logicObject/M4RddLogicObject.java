...
@Entity
@Table(name = "M4RDD_LOGIC_OBJECT", schema = "dbo", catalog = "GLOBALHRPRO140619")
public class M4RddLogicObject {
    ...
    public boolean equals(Object o) {
        ...
        M4RddLogicObject that = (M4RddLogicObject) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(idObject, idTransObjeng, realName, idTransObjesp, idObjectType, idTemporary, idTransObjfra, idNpType, corrected, idTransObjgen, isCacheable, idClsDate, idTransObjger, depCrossMod, haveSecurity, idTransObjita, hasAuditory, idAuditObject, ownerFlag, dtMod, dtCreate, dteClosed, idOrgType, idOrgLevel, inheritsData, hasTableI, idMirrorObject, idTransObjbra, typeMirror, idApprole, idSecuser, dtLastUpdate, transRealName);
    }
}
